...
## See the readme file The files that will be used to load data are listed as follows:
...
## After get the variable data. You can check the in formation
## of data by str() function
